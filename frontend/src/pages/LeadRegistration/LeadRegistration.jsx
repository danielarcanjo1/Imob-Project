      ...
      <div>
         ...
         <form className="form-register-lead">
            <div className="flex flex-col gap">
               <fieldset>
                  <legend>
                     <i className="fa fa-user" aria-hidden="true"></i>DADOS DO
                     CLIENTE
                  </legend>
                  <div>
                     <label for="name">Nome:</label>
                     <input
                        className="input-lead-name"
                        type="text"
                        name="name"
                        id="lead-name"
                        required
               ...
               <fieldset>
                  <legend>
                     <i className="fa fa-search" aria-hidden="true"></i>ORIGEM
                     DO LEAD
                  </legend>
                  <div>
                     <label for="Date">Data da captura</label>
                     <input
                        className="input-lead-capture-date"
                        type="date"
                        name="date"
                        id="date"
                     />
               ...
               <fieldset>
                  ...
                  <div>
                     ...
                     <select className="select-lead" name="" id="">
                        ...
                        <option value="1">
                           Assinar contrato e formulários
                        </option>
               ...
               <fieldset>
                  <legend>
                     <i className="fa fa-users" aria-hidden="true"></i>ATENDENDO
                     O LEAD
                  </legend>
                  <div>
